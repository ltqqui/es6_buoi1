...
tinhDTB=((...e)=>{let n=0;return e.map(e=>{n+=parseFloat(e)}),(n/e.length).toFixed(2)}),
document.getElementById("btnKhoi1").onclick=(()=>{let e=document.getElementById("inpToan").value,
